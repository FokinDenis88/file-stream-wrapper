...
//        if (!write_file_stream << file_content) { throw write_file_error(); }
//
//        // Запись информации непосредственно в файл
//        if (!write_file_stream.flush()) { throw write_file_error(); }
//    } else { throw open_file_error(); }
//
//    if (write_file_stream.is_open()) {
//        if write_file_stream.close();
//        if (write_file_stream.bad()) { throw close_file_error(); }
//    }
//}
